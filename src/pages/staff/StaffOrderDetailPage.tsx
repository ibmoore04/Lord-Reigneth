      ...
      {loading ? (
        ...
        <div className="bg-red-50 border border-red-200 rounded-2xl p-6 text-center">
          ...
          <p className="text-red-400 text-xs mt-2">
            Make sure this order belongs to your assigned outlet.
          </p>
        </div>
      ) : (
          ...
          <div className="bg-white rounded-2xl border border-charcoal-100 p-5">
            ...
            <div className="flex items-center gap-3 mt-3 flex-wrap">
              <span className={cn(
                ...
                {order.order_source === 'website'
                  ? <><Globe className="w-3 h-3" />Website Order</>
            ...
            <div className="space-y-3 text-sm">
              ...
              {order.delivery_address && (
                <div className="flex items-start gap-2 pt-2 border-t border-cream-50">
                  <MapPin className="w-4 h-4 text-charcoal-400 mt-0.5 shrink-0" aria-hidden="true" />
                  <div>
              ...
              {order.customer_notes && (
                <div className="pt-2 border-t border-cream-50">
                  ...
                  <p className="text-charcoal-600 italic text-sm">{order.customer_notes}</p>
                </div>
              )}
            </div>
          </div>
